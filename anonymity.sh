...
function interactive_menu() {
  while true; do
    ...
    echo
    read -p "$(echo -e "${YELLOW}Choose option [0-11] or key in brackets: ${RESET}")" choice
    ...
    *) echo -e "${RED}Invalid option. Please choose between 1-11 or use a hotkey.${RESET}" ;;
     esac
